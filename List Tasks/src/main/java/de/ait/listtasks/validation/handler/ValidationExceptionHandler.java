package de.ait.listtasks.validation.handler;

import de.ait.listtasks.validation.dto.ValidationErrorDto;
import de.ait.listtasks.validation.dto.ValidationErrorsDto;
...
public class ValidationExceptionHandler {
    ...
    public ResponseEntity<ValidationErrorsDto> handleException(MethodArgumentNotValidException e) {
        ...
        // e - исключение, содержит инфу обо всех ошибках, которые произошли в момент запроса с NewUserDto
